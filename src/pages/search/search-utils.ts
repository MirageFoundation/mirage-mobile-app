...
export const SEARCH_TABS: SearchTab[] = ["posts", "topics", "users"];
export const tabToIndex = (tab: SearchTab) => SEARCH_TABS.indexOf(tab);
export const indexToTab = (index: number): SearchTab => SEARCH_TABS[index] ?? "posts";
