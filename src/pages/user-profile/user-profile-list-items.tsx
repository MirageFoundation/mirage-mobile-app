...
MemoizedPostCardItem.displayName = "MemoizedPostCardItem";

const MemoizedProfileCommentItem = memo(ProfileCommentItem, (prev, next) => {
  return (
    prev.comment.post_id === next.comment.post_id &&
    prev.comment.content === next.comment.content &&
    prev.comment.points === next.comment.points
  );
});
MemoizedProfileCommentItem.displayName = "MemoizedProfileCommentItem";

export const PostWrapper = memo(function PostWrapper({
  post,
  isOwnProfile,
  isVisible,
  isFocused,
...
UserProfileCommentWrapper.displayName = "UserProfileCommentWrapper";
